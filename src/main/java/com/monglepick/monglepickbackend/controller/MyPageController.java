...
import com.monglepick.monglepickbackend.dto.response.UserResponse;
import com.monglepick.monglepickbackend.entity.UserPreference;
import com.monglepick.monglepickbackend.entity.UserWishlist;
import com.monglepick.monglepickbackend.entity.WatchHistory;
import com.monglepick.monglepickbackend.service.MyPageService;
 ...
 * <p>API 목록:</p>
 * <ul>
 *   <li>GET /api/v1/mypage/profile - 프로필 조회</li>
 *   <li>GET /api/v1/mypage/watch-history - 시청 이력 조회</li>
 *   <li>GET /api/v1/mypage/wishlist - 위시리스트 조회</li>
 *   <li>POST /api/v1/mypage/wishlist/{movieId} - 위시리스트 추가</li>
 *   <li>DELETE /api/v1/mypage/wishlist/{movieId} - 위시리스트 제거</li>
 *   <li>GET /api/v1/mypage/preferences - 선호도 조회</li>
 * </ul>
 */
@Slf4j
@RestController
...
public class MyPageController {
    ...
    public ResponseEntity<UserResponse> getProfile(
        ...
        UserResponse profile = myPageService.getProfile(userId);
    ...
    public ResponseEntity<Page<WatchHistory>> getWatchHistory(
        ...
        Page<WatchHistory> history = myPageService.getWatchHistory(userId, pageable);
    ...
    public ResponseEntity<Page<UserWishlist>> getWishlist(
        ...
        Page<UserWishlist> wishlist = myPageService.getWishlist(userId, pageable);
    ...
    public ResponseEntity<Void> addToWishlist(
        ...
        myPageService.addToWishlist(userId, movieId);
    ...
    public ResponseEntity<Void> removeFromWishlist(
        ...
        myPageService.removeFromWishlist(userId, movieId);
    ...
    public ResponseEntity<UserPreference> getPreferences(
        ...
        return myPageService.getPreferences(userId)
